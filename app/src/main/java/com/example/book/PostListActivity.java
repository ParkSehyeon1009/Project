    ...
    private void loadPosts() {
        RetrofitInstance.getUserService(this).getPosts().enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(@NonNull Call<List<Post>> call, @NonNull Response<List<Post>> response) {
                Log.d("PostListActivity", "Response Code: " + response.code());
                if (response.body() != null) {
                    Log.d("PostListActivity", "Response Body: " + response.body().toString());
                } else {
                    Log.e("PostListActivity", "Response Body is null");
                }
                if (response.errorBody() != null) {
                    try {
                        Log.e("PostListActivity", "Error Body: " + response.errorBody().string());
                    } catch (IOException e) {
                        Log.e("PostListActivity", "Error reading error body", e);
                    }
                }
            ...
            public void onFailure(@NonNull Call<List<Post>> call, @NonNull Throwable t) {
                Log.e("PostListActivity", "Request failed: " + t.getMessage(), t);
